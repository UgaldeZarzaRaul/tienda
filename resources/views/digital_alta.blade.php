...
<body>
<div class="container">
        <h3>Nuevo Registro de Videojuegos Digitales</h3>
        <h5>CRUD : Videojuegos Digitales -> Registro</h5>
        <hr>
        <br>
        <form action="{{ route('digital_registrar') }}" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
